...
public class RunBy {
    ...
    public RunBy withDisplayName(String displayName) {
        this.displayName = displayName;
        return this;
    }
    ...
    public RunBy withUniqueName(String uniqueName) {
        this.uniqueName = uniqueName;
        return this;
    }
    ...
    public RunBy withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public RunBy withImageUrl(String imageUrl) {
        this.imageUrl = imageUrl;
        return this;
    }
