...
public class TfsSuite {
    ...
    @SerializedName("parentSuiteIDAtomation")
    @Expose
    private String parentSuiteIDAtomation;
    ...
    public TfsSuite withPlanIdPfizer(String planIdPfizer) {
        this.planIdPfizer = planIdPfizer;
        return this;
    }
    ...
    public TfsSuite withSourceSuiteIDEmployerNoExecution(String sourceSuiteIDEmployerNoExecution) {
        this.sourceSuiteIDEmployerNoExecution = sourceSuiteIDEmployerNoExecution;
        return this;
    }

    public String getParentSuiteIDAtomation() {
        return parentSuiteIDAtomation;
    }

    public void setParentSuiteIDAtomation(String parentSuiteIDAtomation) {
        this.parentSuiteIDAtomation = parentSuiteIDAtomation;
    }

    public TfsSuite withParentSuiteIDAtomation(String parentSuiteIDAtomation) {
        this.parentSuiteIDAtomation = parentSuiteIDAtomation;
        return this;
    }
    ...
    public TfsSuite withNewSuiteNameEmployer(String newSuiteNameEmployer) {
        this.newSuiteNameEmployer = newSuiteNameEmployer;
        return this;
    }
    ...
    public TfsSuite withScope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public TfsSuite withDomain(String domain) {
        this.domain = domain;
        return this;
    }
    ...
    public TfsSuite withWorkstation(String workstation) {
        this.workstation = workstation;
        return this;
    }
    ...
    public TfsSuite withGlobalUsername(String globalUsername) {
        this.globalUsername = globalUsername;
        return this;
    }
    ...
    public TfsSuite withGlobalPassword(String globalPassword) {
        this.globalPassword = globalPassword;
        return this;
    }
    ...
    public TfsSuite withBaseURI(String baseURI) {
        this.baseURI = baseURI;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TfsSuite.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        ...
        sb.append(',');
        sb.append("parentSuiteIDAtomation");
        sb.append('=');
        sb.append(((this.parentSuiteIDAtomation == null)?"<null>":this.parentSuiteIDAtomation));
        sb.append(',');
    ...
    public int hashCode() {
        int result = 1;
        result = ((result* 31)+((this.parentSuiteIDAtomation == null)? 0 :this.parentSuiteIDAtomation.hashCode()));
