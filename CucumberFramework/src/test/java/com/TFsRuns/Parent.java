...
public class Parent {
    ...
    public Parent withIsAutomated(Boolean isAutomated) {
        this.isAutomated = isAutomated;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (((((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name)))&&((this.pointIds == rhs.pointIds)||((this.pointIds!= null)&&this.pointIds.equals(rhs.pointIds))))&&((this.isAutomated == rhs.isAutomated)||((this.isAutomated!= null)&&this.isAutomated.equals(rhs.isAutomated))))&&((this.plan == rhs.plan)||((this.plan!= null)&&this.plan.equals(rhs.plan))));
    }
