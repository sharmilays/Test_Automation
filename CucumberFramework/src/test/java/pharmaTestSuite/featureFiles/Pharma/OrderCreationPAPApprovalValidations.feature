@OrderCreationPAPApprovalValidationsfeature
Feature: Pfizer Order Creation when PAP enrollment Application is approved

  @84619
  Scenario Outline: Login Pfizer PAP Agent User>Patient's PAP application is approved> Verify user is  able to create new order based on the medication specifications mentioned on the prescription.
    ...
    Examples: 
      | TC_ID               |  | TestDataSheet |
      | OrderCreation_84619 |  | OrderCreation |

  @84620
  Scenario Outline: Login Pfizer PAP Agent User Patients PAP application is approved Verify user is  able to create new order based on the medication specifications mentioned on the prescription
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID               |  | TestDataSheet |
      | OrderCreation_84620 |  | OrderCreation |

  @84621
  Scenario Outline: Login Pfizer PAP Agent User>PAP enrolled> Verify that PAP application is approved only after validation
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID               |  | TestDataSheet |
      | OrderCreation_84621 |  | OrderCreation |

  @84622
  Scenario Outline: Login Pfizer PAP Agent User>PAP enrolled> PAP validated and approved>Verify that user is able to create Order with Order Status = “Activated” initially.
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID               |  | TestDataSheet |
      | OrderCreation_84622 |  | OrderCreation |

  @84623
  Scenario Outline: Login Pfizer PAP Agent User>PAP enrolled> PAP validated and approved>Prescription contains multiple products> Verify user is able to create multiple orders per product.
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID               |  | TestDataSheet |
      | OrderCreation_84623 |  | OrderCreation |

  @84624
  Scenario Outline: Login Pfizer PAP Agent User PAP enrolled PAP validated and approved Order cerated Inbound call received from patient with order ID Verify User is able to perform a global search based on the Order Id
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID               |  | TestDataSheet |
      | OrderCreation_84624 |  | OrderCreation |

  @84625
  Scenario Outline: Login Pfizer PAP Agent User PAP enrolled PAP validated and approved Order cerated Verify user is able to see all the orders created by the patient to the current active application
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID               |  | TestDataSheet |
      | OrderCreation_84625 |  | OrderCreation |
