@ApplicationPrescriptionProductGroupfeature
Feature: Application Prescription: Product Group

  @174350
  Scenario Outline: Verify that user should not get the OVM error message when the two different Products of same group are added and should be able to create
    ...
    Examples: 
      | TC_ID                                  |  | TestDataSheet                   |
      | ApplicationPrescriptionProductG_174350 |  | ApplicationPrescriptionProductG |

  @167364
  Scenario Outline: Verify that Fullfillment Method should be defaulted to Medvantx and Ship To=Patient when the user select the Group B products on the Prescription
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                                  |  | TestDataSheet                   |
      | ApplicationPrescriptionProductG_167364 |  | ApplicationPrescriptionProductG |
  ...
  Scenario Outline: Verify that Fullfillment Method should be defaulted to Medvantx and Ship To=Patient when the user select the Group B products on the Prescription
    ...
    Examples: 
      | TC_ID                                  |  | TestDataSheet                   |
      | ApplicationPrescriptionProductG_167363 |  | ApplicationPrescriptionProductG |
