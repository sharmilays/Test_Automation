@PrescriptionPageValidations
Feature: Prescription page validations

  @166121
  Scenario Outline: Verify that OVM message should display when the Prescriber Consent signature Date information missed
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_166121 |  | PrescriptionPageValidations |

  @166125
  Scenario Outline: Verify that user should not be able to save the Prescription page without adding Practitioner details
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_166125 |  | PrescriptionPageValidations |

  @166152
  Scenario Outline: Verify that user should get the Prescription validation message when the user tried to save the prescription without SIG value
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_166152 |  | PrescriptionPageValidations |
  ...
  Scenario Outline: Verify that OVM message should display when the Prescriber Consent signature Date information missed
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_166993 |  | PrescriptionPageValidations |

  @167055
  Scenario Outline: Verify that creating new prescription is blocked and notification message is displayed when the user tried to save the prescription page with same Practitioner and same NDC of previous prescription
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_167055 |  | PrescriptionPageValidations |

  @167841
  Scenario Outline: Verify that creating new prescription is blocked and notification message is displayed when the user tried to save the prescription page with same Practitioner and same NDC of previous prescription is Mandatory
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_167841 |  | PrescriptionPageValidations |

  @175340
  Scenario Outline: verify that we are not allowed to enter negative value to quantity field and save the prescription
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_175340 |  | PrescriptionPageValidations |

  @176429
  Scenario Outline: Verify that product line is not going away after adding LOE or Prevnar product in 2nd Prescirpition with same practitioner and product details (Added LOE or Prevnar in 1st prescription)
     t has opened and Select Document>Click on 'AttaCh'
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_176429 |  | PrescriptionPageValidations |
  ...
  Scenario Outline: Verify that product line is not going away after adding LOE or Prevnar product in 2nd Prescirpition with same practitioner and product details (Added LOE or Prevnar in 1st prescription)
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_167113 |  | PrescriptionPageValidations |
  ...
  Scenario Outline: Verify that product line is not going away after adding LOE or Prevnar product in 2nd Prescirpition with same practitioner and product details (Added LOE or Prevnar in 1st prescription)
    ...
    Examples: 
      | TC_ID                                 |  | TestDataSheet               |
      | PrescriptionPageValidations_167113_01 |  | PrescriptionPageValidations |

  @167061
  Scenario Outline: Verification of 'Refill not allowed' Message for Group C (Prevnar 13)
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_167061 |  | PrescriptionPageValidations |

  @191910
  Scenario Outline: Verify order cannot be created in CRM  for specific list of strings Case in sensitive
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet               |
      | POBoxAddressrule_191910 |  | PrescriptionPageValidations |

  @191914
  Scenario Outline: Verify  When a HCP logs into the portal to order a refill with a PO Box Address. Hcp will be unable to place refill order
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet               |
      | POBoxAddressrule_191914 |  | PrescriptionPageValidations |

  @191918
  Scenario Outline: Verify that if Patient's Shipping address is a Po box address without string PO Box then User is not able to create order
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet               |
      | POBoxAddressrule_191918 |  | PrescriptionPageValidations |

  @M191919
  Scenario Outline: Verify that if HCP's Shipping address is a PO Box address without String PO Box User is not able to create order
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet               |
      | POBoxAddressrule_191919 |  | PrescriptionPageValidations |
  ...
  @98323
  Scenario Outline: 93974 - Display Package size on application prescription and view orders along with Form & Strength for all products.
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID             |  | TestDataSheet               |
      | PackageSize_98323 |  | PrescriptionPageValidations |

  @227879
  Scenario Outline: Pfizer: CRM Agent Login> Verify that user is able to add a new product on application prescription page
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID              |  | TestDataSheet               |
      | PackageSize_227879 |  | PrescriptionPageValidations |

  @227880
  Scenario Outline: Pfizer: Agent Login->Added a new product on application prescription page->Verify that user is able to view the package size of the product selected along with Form and Strength values
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID              |  | TestDataSheet               |
      | PackageSize_227880 |  | PrescriptionPageValidations |

  @227881
  Scenario Outline: Pfizer: Agent Login->Added a new product on application prescription page-> Package size of along with Form and Strength values is displayed->Verify user is able to enter the appropriate pill count.
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID              |  | TestDataSheet               |
      | PackageSize_227881 |  | PrescriptionPageValidations |

  @227882
  Scenario Outline: Pfizer: Agent Login->Navigate to Application prescription page->In Product Information section->Verify that "Form – Strength" field rename to "Form – Strength – Package"
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID              |  | TestDataSheet               |
      | PackageSize_227882 |  | PrescriptionPageValidations |

  @227883
  Scenario Outline: Pfizer: Agent Login->Navigate to Application prescription page->In Product Information section->Verify that "Qty" field rename to "Pill Qty"
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID              |  | TestDataSheet               |
      | PackageSize_227883 |  | PrescriptionPageValidations |

  @227884
  Scenario Outline: Go to Appliaction Page and Click on View Orders->In Available Orders section->Verify that package size of the product is displaying against each order
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID              |  | TestDataSheet               |
      | PackageSize_227884 |  | PrescriptionPageValidations |
  ...
  Scenario Outline: Verify that Strength field rename to "Strength – Package"
    ...
    Examples: 
      | TC_ID              |  | TestDataSheet               |
      | PackageSize_227886 |  | PrescriptionPageValidations |

  @191915
  Scenario Outline: Verify that order cannot be created for specified list of strings in Portal (Case in sensitive)
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_191915 |  | PrescriptionPageValidations |

  @191920
  Scenario Outline: Verify that if Last order shipping address is PO Box address without String PO Box in Portal User is blocked from creating Refill order
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_191920 |  | PrescriptionPageValidations |

  @106598
  Scenario Outline: Verify that user is able to view the “Memphis Pack Count” field
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_106598 |  | PrescriptionPageValidations |

  @106599
  Scenario Outline: Verify that “Memphis Pack Count” value should be displayed automatically
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_106599 |  | PrescriptionPageValidations |

  @106601
  Scenario Outline: Verify that “Memphis Pack Count” value should be displayed as “N/A”.
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_106601 |  | PrescriptionPageValidations |

  @106602
  Scenario Outline: Verify that “Memphis Pack Count” field should be numeric only
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_106602 |  | PrescriptionPageValidations |

  @106604
  Scenario Outline: Verify that “Memphis Pack Count” field should be read only, should not updateable by the agent
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_106604 |  | PrescriptionPageValidations |

  @106607
  Scenario Outline: Verify that respective pack count should be displayed on the field “Memphis Pack Count”
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_106607 |  | PrescriptionPageValidations |
  ...
  Scenario Outline: Verify that “Memphis Pack Count” value should be displayed as “N/A”.
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_106608 |  | PrescriptionPageValidations |
  ...
  Scenario Outline: Verify that “Memphis Pack Count” field should be numeric only
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_106609 |  | PrescriptionPageValidations |
  ...
  Scenario Outline: Verify that “Memphis Pack Count” field should be read only, should not updateable by the agent
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_106610 |  | PrescriptionPageValidations |

  @106605
  Scenario Outline: Verify that displayed “Memphis Pack Count” value should be be equal to  Pack Count (pill quantity) / Stock bottle Quantity
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_106605 |  | PrescriptionPageValidations |
  ...
  Scenario Outline: Verify that displayed “Memphis Pack Count” value should be be equal to  Pack Count (pill quantity) / Stock bottle Quantity
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_106611 |  | PrescriptionPageValidations |

  @167842
  Scenario Outline: Verify that creating new prescription is not blocked in the Re-Enrollment Application when the user tried to save the prescription page with same Practitioner and same NDC of previous Enrollment prescription
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_167842 |  | PrescriptionPageValidations |

  @167843
  Scenario Outline: Verify that a pop up notification message with yes or no should not display in the Re-Enrollment Application when the user tried to save the prescription page with different Practitioner and same NDC of previous Enrollment prescription
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | PrescriptionPageValidations_167843 |  | PrescriptionPageValidations |

  #--Sharmila---Start
  @372615 @372616 @372617 @372619 @372624
  Scenario Outline: NoPractitioner_TC_01_TC_02_TC_03_TC_05_TC_10
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Then Select 'Select Service Offering' to Enrollment and attach second document
    And Verify Section to Enter Application Information and PAP Information must get displayed
    And Verify User is not able to view 'Missing Prescription Information' checkbox
    #372615
    Then In 'Application Information' section Select 'Application Source' > Check 'Patient or Patient Representative Signature'
    And Set ' E verification income Opt In or Opt out ' as 'Y' > Select Patient or Patient Representative Signature Date
    Then Verify  All the details Should get selected
    ...
    And Click on 'Application Prescriptions' > 'New' 
    Then Verify User must be redirected to Application Prescription page
    And Verify User is able to see 'Prescriber Details are Missing' Checkbox in the Prescription page
    And Verify User is able to check the 'Prescriber Details are Missing' Checkbox under Practitioner Information Section
    ...
    And Click on Attach Button
    Then Verify new window to attach Second ReEnrollment document has opened and Select Document>Click on 'AttaCh'
    And Verify User is able to Save the Application Prescription without entering any Practitioner related details

    Examples: 
      | TC_ID                                             |  | TestDataSheet               |
      | NoPractitioner_372615_372616_372617_372619_372624 |  | PrescriptionPageValidations |

  #--Sharmila--End
  #---Vivek Start
  @372621
  Scenario Outline: NoPractitioner_TC_07
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                 |  | TestDataSheet               |
      | NoPractitioner_372621 |  | PrescriptionPageValidations |

  @372623 @372625
  Scenario Outline: NoPractitioner_TC_09_11
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                        |  | TestDataSheet               |
      | NoPractitioner_372623_372625 |  | PrescriptionPageValidations |

  @372618 @372626
  Scenario Outline: NoPractitioner_TC_04_TC_12
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                        |  | TestDataSheet               |
      | NoPractitioner_372618_372626 |  | PrescriptionPageValidations |

  @372628 @372629
  Scenario Outline: NoPractitioner_TC_14_TC_15
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                        |  | TestDataSheet               |
      | NoPractitioner_372628_372629 |  | PrescriptionPageValidations |

  #---Vivek END
  #--Manoj Start
  @372620
  Scenario Outline: NoPractitioner_TC_06
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                 |  | TestDataSheet               |
      | NoPractitioner_372620 |  | PrescriptionPageValidations |

  @372633 @372635
  Scenario Outline: NoPractitioner_TC_19_To verify Prescriber Missing details flag is getting disabled once the practitioner is selected and added on prescription page.
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                        |  | TestDataSheet               |
      | NoPractitioner_372633_372635 |  | PrescriptionPageValidations |

  @372636
  Scenario Outline: To verify that agent is able to fill all the details for the editable fields once the Prescriber Missing Information flag is checked.
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                 |  | TestDataSheet               |
      | NoPractitioner_372636 |  | PrescriptionPageValidations |

  @372634
  Scenario Outline: NoPractitioner_TC_20
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                 |  | TestDataSheet               |
      | NoPractitioner_372634 |  | PrescriptionPageValidations |
  ...
  Scenario Outline: Verify that creating a new prescription is blocked and notification message is displayed when trying to create a new prescription for the same practitioner,same product, form,strength and number of refills remaining is greater than  0
    ...
    Examples: 
      | TC_ID                            |  | TestDataSheet               |
      | DuplicateNDCPrescriptions_372726 |  | PrescriptionPageValidations |

  @372727
  Scenario Outline: Verify that creating a new prescription is not blocked and order is released after 75% utilization of previous order when creating a new prescription for the same practitioner,same product, form,strength and number of refills remaining is 0
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                            |  | TestDataSheet               |
      | DuplicateNDCPrescriptions_372727 |  | PrescriptionPageValidations |

  @372728_372729
  Scenario Outline: Verify that new RX can be created and proceed when Dosage Increased(Different NDC)
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                                   |  | TestDataSheet               |
      | DuplicateNDCPrescriptions_372728_372729 |  | PrescriptionPageValidations |
