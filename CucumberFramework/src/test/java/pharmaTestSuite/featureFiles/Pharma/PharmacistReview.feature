@PharmacistReview.feature
Feature: Lyrica/Non-Lyrica validations

  @193757
  Scenario Outline: Pharmacist Review Required” and “Pharmacist Review Reason” fields are visible and able to check the checkbox and select reason
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet    |
      | PharmacistReview_193757 |  | PharmacistReview |

  @191942
  Scenario Outline: Pharmacist select the checkbox 'Pharmacist review complete' and completes review>Verify that event should be logged as 'pharmacist review'
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet    |
      | PharmacistReview_191942 |  | PharmacistReview |
  ...
  Scenario Outline: Pfizer CRM agent/supervisor login>Application created>Prescription>Addproducts other than Lyrica/lyrica CR>Verify that ' Pharmacist Review'
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet    |
      | PharmacistReview_193758 |  | PharmacistReview |

  @193759
  Scenario Outline: Pfizer CRM agent/supervisor login>Application created>Prescription>Add Lyrica product>Pharmacist review required checkbox checked>Pharmacist review reason field is blank>save prescription>Verify that Alert is displayed
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet    |
      | PharmacistReview_193759 |  | PharmacistReview |

  @193760
  Scenario Outline: Pfizer CRM agent/supervisor login>Application created>Prescription>Add Lyrica product>Pharmacist review required checked>Pharmacist Review Reason selected>Verify that agent is able to save and determine outcome to initiate 'Pharmacist review process'
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet    |
      | PharmacistReview_193760 |  | PharmacistReview |
  ...
  Scenario Outline: Pfizer CRM agent/supervisor login>Application created>Prescription>Add Lyrica product>Pharmacist review required checked>Pharmacist Review Reason selected>Verify that agent is able to save and determine outcome to initiate 'Pharmacist review process'
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet    |
      | PharmacistReview_193761 |  | PharmacistReview |

  @193762
  Scenario Outline: Pfizer CRM agent/supervisor login>Application created>Prescription>Add Lyrica product>Pharmacist review required checked>Pharmacist Review Reason selected>Save and determine outcome>Verify that application status should be Incomplete
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet    |
      | PharmacistReview_193762 |  | PharmacistReview |

  @193763
  Scenario Outline: Agent login>Precription product list view>Verify that agent is not able to edit the Review Completed and Comments fields
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet    |
      | PharmacistReview_193763 |  | PharmacistReview |

  @193764
  Scenario Outline: Agent login>Prescription product>Verify that agent has not have access to Pharmacist review pending list view
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet    |
      | PharmacistReview_193764 |  | PharmacistReview |

  @193767
  Scenario Outline: Pfizer CRM Pharmacist login>Prescription product>Prescription flagged for pharmacist review>Pharmacist select the checkbox Pharmacist review complete and completes review>Verify that event should be logged as pharmacist review completed
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet    |
      | PharmacistReview_193767 |  | PharmacistReview |

  @193765
  Scenario Outline: Pharmacist review completed>Agent login>prescription product>Pharmacist review completed list view>Verfiy that agent is able to create order
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet    |
      | PharmacistReview_193765 |  | PharmacistReview |
  ...
  Scenario Outline: Pfizer CRM Pharmacist login>Precription product>Pharmacist review pending list view>Prescription flagged for pharmacist review>Verify that Pharmacist
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet    |
      | PharmacistReview_193766 |  | PharmacistReview |
