@PNOP
Feature: Product Not On Program

  @185583
  Scenario Outline: Verify  that User should get the OVM message “Product not on Program”  with outcome as a Denial
  ...
  @185584
  Scenario Outline: Verify that user should not get the Create order button
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
  ...
  @185585
  Scenario Outline: Verify that Approval Status should  be equal to  Denied
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
  ...
  @185586
  Scenario Outline: Verify that Outcome Validations Log should be created for the Denied outcome
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
  ...
  @185590
  Scenario Outline: Verify that agent should not able to do PAP Appeal
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
  ...
  @185591
  Scenario Outline: Verify  that User should get the OVM message "Not Client Product"   with outcome as a Denial
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
