@RequirementElicitationChantixRulesfeature
Feature: Requirement Elicitation : Chantix Rules
  ...
  Scenario Outline: Verify that agent is not able to create order for more than 1pack of memphis pack count per perscription for a 30 days supply
    ...
    Examples: 
      | TC_ID          |  | TestDataSheet |
      | Chantix_186401 |  | Chantix       |

  @186603
  Scenario Outline: Verify that ovm message should be displayed saying 'Only 1 Memphis pack count allowed on Chantix Starting Month Pack – 0.5mg, please update the pill quantity to 53'
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
  ...
  Scenario Outline: Verify that agent not able to add or save prescription with chantix starting pack more than 1pack of memphis pack count
    ...
    Examples: 
      | TC_ID          |  | TestDataSheet |
      | Chantix_186604 |  | Chantix       |

  @186605
  Scenario Outline: Verify that agent is not able to create order for 1 more pack of chantix starting month and message will be displayed
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID          |  | TestDataSheet |
      | Chantix_186605 |  | Chantix       |

  @186606
  Scenario Outline: Add product line  Chantix - Starting month pack - 0.5mg>Verify that agent is able to create order for 1 more pack of chantix starting month
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
  ...
  Scenario Outline: Verify that agent is able to place Correction order for chantix starting month pack - 0.5mg in same prescription
    ...
    Examples: 
      | TC_ID          |  | TestDataSheet |
      | Chantix_186607 |  | Chantix       |

  @186608
  Scenario Outline: Verify that agent is able to place Replacement order for chantix starting month pack - 0.5mg in same prescription
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID          |  | TestDataSheet |
      | Chantix_186608 |  | Chantix       |

  @186609
  Scenario Outline: Verify that agent is able to create Initial order for chantix starting month pack - 0.5mg
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID          |  | TestDataSheet |
      | Chantix_186609 |  | Chantix       |

  @186610
  Scenario Outline: Verify that agent is not able to create Initial order for chantix starting month pack - 0.5mg with more than 1 refills
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID          |  | TestDataSheet |
      | Chantix_186610 |  | Chantix       |

  @186612
  Scenario Outline: Verify that agent is able to save prescription and create order for chantix starting month pack in second prescription
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID          |  | TestDataSheet |
      | Chantix_186612 |  | Chantix       |

  @186611
  Scenario Outline: Verify that OVM message is not able to create Initial order for chantix starting month pack - 0.5mg with more than 1 refills
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID          |  | TestDataSheet |
      | Chantix_186611 |  | Chantix       |

  @186614
  Scenario Outline: Continuiing month packs added in new product line for same prescription>total pack counts of continuing month packs<5(1 to 5)>Pap Determine outcome> Verify that agent is able to create order
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID          |  | TestDataSheet |
      | Chantix_186614 |  | Chantix       |

  @186613
  Scenario Outline: Continuiing month packs added in new product line for same prescription>Pap Determine outcome> Verify that alert message should not be displayed
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
  ...
  Scenario Outline: Verify that alert message should be displayed like patient can only receive packs less than 5
    ...
    Examples: 
      | TC_ID          |  | TestDataSheet |
      | Chantix_186615 |  | Chantix       |

  @186616
  Scenario Outline: Verify that agent is able to place order for chantix starting pack and continuing packs
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID          |  | TestDataSheet |
      | Chantix_186616 |  | Chantix       |

  @186617
  Scenario Outline: Verify that agent is not able to place order for chantix starting pack and continuing packs
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    And Select a value from Reason Dropdown
    Then Click on Save and proceed Button
    And Select Pill quantity more than 280 in Third
    Then Click on Save Button
    # And Switch to prescription page Frame
    Then Verify 'patient can recieve only 5 Chantix Countinuing pack' Error Message is Displayed
    ...
    Examples: 
      | TC_ID          |  | TestDataSheet |
      | Chantix_186617 |  | Chantix       |

  @186623
  Scenario Outline: Total memphis pack count of continuing or maintenance month pack already availed per prescription is less than 5>Refill request via Portal>Verify that HCP can place a refill upto total of 5 memphis pack count per prescription
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID          |  | TestDataSheet |
      | Chantix_186623 |  | Chantix       |

  @186624
  Scenario Outline: Chantix starting month pack already availed by per prescription>Order shipped>Refill request refill via Portal for starting month pack>Verify that HCP cannot place refill for starting month pack and custom message should displayed
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID          |  | TestDataSheet |
      | Chantix_186624 |  | Chantix       |

  @186622
  Scenario Outline: Total 5 memphis pack count of continuing or maintenance month pack already availed per prescription>Refill request via Portal>Verify that HCP cannot place a refill and Custom message will be displayed
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
  ...
  Scenario Outline: Verify that approx next refill date is displayed correctly in view orders page
    ...
    Examples: 
      | TC_ID          |  | TestDataSheet |
      | Chantix_189189 |  | Chantix       |

  @189187
  Scenario Outline: Chantix continuing month pack of 5 pack counts availed in older prescription>Verify that agent is not able to save and create order across prescription because  chantix continuing month packs count will be >5 across prescriptions
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
