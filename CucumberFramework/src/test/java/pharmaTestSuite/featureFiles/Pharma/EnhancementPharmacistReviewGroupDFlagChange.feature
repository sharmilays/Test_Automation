@EnhancementPharmacistReviewGroupDFlagChangefeature
Feature: Enhancement - Pharmacist Review Group D Flag Change

  @231186
  Scenario Outline: Pfizer CRM agent/supervisor login>Application created>Prescription>Add Lyrica product>Verify that Pharmacist Review Required checkbox
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | EnhancementPharmacistReview_231186 |  | EnhancementPharmacistReview |

  @231187
  Scenario Outline: Pfizer CRM agent/supervisor login>Application created>Prescription>Addproducts other than Lyrica/lyrica CR>Verify that Pharmacist Review
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | EnhancementPharmacistReview_231187 |  | EnhancementPharmacistReview |

  @231188
  Scenario Outline: Pfizer CRM agent/supervisor login>Application created>Prescription>Add Lyrica/lyrica CR product>Verify that agent is able to select the checkbox
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | EnhancementPharmacistReview_231188 |  | EnhancementPharmacistReview |

  @231189
  Scenario Outline: Pfizer CRM agent/supervisor login>Application created>Prescription>Add Lyrica/lyrica CR product>Pharmacist review required checkbox checked
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | EnhancementPharmacistReview_231189 |  | EnhancementPharmacistReview |

  @231190
  Scenario Outline: Add Lyrica/lyrica CR >Pharmacist review required checked>Pharmacist Review Reason selected>Verify that agent is able to save and determine
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | EnhancementPharmacistReview_231190 |  | EnhancementPharmacistReview |
  ...
  Scenario Outline: Pfizer CRM agent/supervisor login>Application created>Prescription>Add Lyrica/lyrica CR product>Pharmacist review required checkbox checked
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | EnhancementPharmacistReview_231192 |  | EnhancementPharmacistReview |

  @E231210
  Scenario Outline: Add Lyrica/lyrica CR >Pharmacist review required checkbox checked>Verify that agent is able to select a reason from drop down list available as
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | EnhancementPharmacistReview_231210 |  | EnhancementPharmacistReview |

  @231212
  Scenario Outline: Pfizer CRM agent/supervisor login>Precription product>Pharmacist review Completed list view>Verify that the Pharmacist Review Completed
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | EnhancementPharmacistReview_231212 |  | EnhancementPharmacistReview |

  @231213
  Scenario Outline: Pfizer CRM agent/supervisor login>Precription product>Pharmacist review Completed list view>Verify that user navigate to Prescription page by
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | EnhancementPharmacistReview_231213 |  | EnhancementPharmacistReview |

  @231215
  Scenario Outline: Pfizer CRM agent/supervisor login>Application created>Prescription>Add Lyrica product>Pharmacist review required checked>Pharmacist Review
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | EnhancementPharmacistReview_231215 |  | EnhancementPharmacistReview |
  ...
  Scenario Outline: Pfizer CRM agent/supervisor login>Application created>Prescription>Add Lyrica product>Pharmacist review required checked>Pharmacist Review
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | EnhancementPharmacistReview_231216 |  | EnhancementPharmacistReview |

  @231221
  Scenario Outline: Add Lyrica >Pharmacist review required checked>Pharmacist Review Reason selected>Save and determine outcome>Verify that application status
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | EnhancementPharmacistReview_231221 |  | EnhancementPharmacistReview |

  @231260
  Scenario Outline: Pfizer CRM Pharmacist login>Precription product>Pharmacist review pending list view>Verify that Pharmacist should be able to see the prescription
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | EnhancementPharmacistReview_231260 |  | EnhancementPharmacistReview |

  @231261
  Scenario Outline: Pfizer CRM Pharmacist login>Precription product>Pharmacist review pending list view>Prescription flagged for pharmacist review>Verify that Pharmacist
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | EnhancementPharmacistReview_231261 |  | EnhancementPharmacistReview |

  @231262
  Scenario Outline: Pfizer CRM Pharmacist login>Precription product>Pharmacist review pending list view>Prescription flagged for pharmacist review>Verify that Pharmacist should be able to select the checkbox "Pharmacist review complete"once review is complete
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | EnhancementPharmacistReview_231262 |  | EnhancementPharmacistReview |

  @231263
  Scenario Outline: Pharmacist login>Prescription product> pending list view>Prescription for pharmacist review>Pharmacist completes review>Verify that once review
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                              |  | TestDataSheet               |
      | EnhancementPharmacistReview_231263 |  | EnhancementPharmacistReview |

  @231214
  Scenario Outline: Verify that user should able to see the Pharmacists comments in comment box and should not be editable by Agent
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet    |
      | PharmacistReview_231214 |  | PharmacistReview |

  @231217
  Scenario Outline: Verfiy that agent is able to create order for prescriptions with pharmacist review completed
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet    |
      | PharmacistReview_231217 |  | PharmacistReview |

  @231264
  Scenario Outline: Verify that only pharmacist able to edit the Review Completed and Comments fields
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet    |
      | PharmacistReview_231264 |  | PharmacistReview |

  @231266
  Scenario Outline: Verify that event should be logged as "pharmacist review has been completed"
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    ...
    Examples: 
      | TC_ID                   |  | TestDataSheet    |
      | PharmacistReview_231266 |  | PharmacistReview |
