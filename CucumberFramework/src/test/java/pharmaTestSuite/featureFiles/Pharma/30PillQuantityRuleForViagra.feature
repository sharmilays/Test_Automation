@30PillQuantityruleforViagra
Feature: 30 Pill Quantity rule for Viagra

  @191814
  Scenario Outline: CRM Agent Login> Verify that user is able to add the product Viagra
    ...
    Examples: 
      | TC_ID                |  | TestDataSheet |
      | RuleForViagra_191814 |  | RuleForViagra |

  @191815
  Scenario Outline: CRM Agent Login> Viagra Product Added > Verify user able to enter Pill Quantity as 30
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                |  | TestDataSheet |
      | RuleForViagra_191815 |  | RuleForViagra |

  @191816
  Scenario Outline: Verify that user is able to create order with 90 day supply and Supervisor override is not allowed on these orders.
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                |  | TestDataSheet |
      | RuleForViagra_191816 |  | RuleForViagra |

  @191817 @191817_2
  Scenario Outline: CRM Agent Login> Viagra Product Added > Entered Viagra pill quantity more or less than 30 pills > Clicked on PAP Determine outcome > Verify that OVM Window throws Final outcome as Incomplete
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                  |  | TestDataSheet |
      | RuleForViagra_191817   |  | RuleForViagra |
      | RuleForViagra_191817_2 |  | RuleForViagra |
  ...
  Scenario Outline: CRM Agent Login> Viagra Product Added > Entered Viagra pill quantity more or less than 30 pills > Clicked on PAP Determine outcome > Verify that OVM Window throws Final outcome as Incomplete
    ...
    Examples: 
      | TC_ID                  |  | TestDataSheet |
      | RuleForViagra_191818   |  | RuleForViagra |
      | RuleForViagra_191818_2 |  | RuleForViagra |

  @191819 @191819_2
  Scenario Outline: CRM Agent Login> Viagra Product Added > Entered Viagra pill quantity more or less than 30 pills > Clicked on PAP Determine outcome > Verify that Supervisor Override button is not getting displayed
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                  |  | TestDataSheet |
      | RuleForViagra_191819   |  | RuleForViagra |
      | RuleForViagra_191819_2 |  | RuleForViagra |
  ...
  Scenario Outline: CRM Agent Login> Viagra Product Added > Entered Viagra pill quantity more or less than 30 pills > Clicked on PAP Determine outcome > Verify that Supervisor Override button is not getting displayed
    ...
    Examples: 
      | TC_ID                  |  | TestDataSheet |
      | RuleForViagra_191873   |  | RuleForViagra |
      | RuleForViagra_191873_2 |  | RuleForViagra |

  @191874
  Scenario Outline: Verify that user is not able to generate letters to the patient/practitioner for this incomplete reason.
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                |  | TestDataSheet |
      | RuleForViagra_191874 |  | RuleForViagra |
