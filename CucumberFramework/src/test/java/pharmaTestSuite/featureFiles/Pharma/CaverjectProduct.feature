@CaverjectImpulse
Feature: Add 2 new NDC for Caverject Impulse

  @185526
  Scenario Outline: Pfizer: CRM Agent Login> New Application enrolled>Prescription added>Add Caverject Impulse product via CRM>Verify that agent should be able to see/Select the  2 new NDC’s active for Caverject impulse
    ...
    Examples: 
      | TC_ID            |  | TestDataSheet |
      | Caverject_185526 |  | Caverject     |

  @185527
  Scenario Outline: Pfizer: CRM Agent Login> New Application enrolled>Prescription added>Add Caverject Impulse product via CRM>Verify that new NDC’s added will be aligned to Group A products
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID            |  | TestDataSheet |
      | Caverject_185527 |  | Caverject     |

  @185528
  Scenario Outline: Pfizer: CRM Agent Login> New Application enrolled>Prescription added>Add Caverject Impulse product via CRM>Verify that the product should be defaulted to be shipped via Memphis & to HCP
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID            |  | TestDataSheet |
      | Caverject_185528 |  | Caverject     |

  @185529
  Scenario Outline: Pfizer: CRM Agent Login> New Application enrolled>Prescription added>Add Caverject Impulse product via CRM>Verify that on application prescription the refills should be defaulted to 4
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID            |  | TestDataSheet |
      | Caverject_185529 |  | Caverject     |

  @185530
  Scenario Outline: Pfizer: CRM Agent Login> New Application enrolled>Prescription added>Add Caverject product via CRM>Verify that “Form” representation of the existing NDC’s 0009-3701-05 & 0009-7686-04 should be updated from “Vial” to “Powder vial only”.
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID            |  | TestDataSheet |
      | Caverject_185530 |  | Caverject     |

  @185531
  Scenario Outline: Pfizer: CRM Agent Login> New Application enrolled>Prescription added>Add Caverject product via CRM>Verify that no other data elements to be updated except for form
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID            |  | TestDataSheet |
      | Caverject_185531 |  | Caverject     |

  @185538
  Scenario Outline: Pfizer: CRM Agent Login> Initial order created & shipped for Caverject impulse product via CRM Pfizer: Portal HCP Login>Verify that Product name is displayed along with superscript and generic name for both the new NDC’s added.
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID            |  | TestDataSheet |
      | Caverject_185538 |  | Caverject     |

  @185545
  Scenario Outline: Initial order created & shipped for Caverject impulse product via CRM Pfizer: Portal HCP Login>Verify that HCP should be able to place a refill via portal for the new NDC’s added for Caverject Impulse once the patient had met the eligible for refill date
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID            |  | TestDataSheet |
      | Caverject_185545 |  | Caverject     |

  @185547
  Scenario Outline: Initial order created & shipped for Caverject product via CRM Pfizer: Portal HCP Login>Verify that HCP should be able to place a refill via portal confirm the new form value “Powder Vial Only” is reflected in Portal for Caverject NDC’s.
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
