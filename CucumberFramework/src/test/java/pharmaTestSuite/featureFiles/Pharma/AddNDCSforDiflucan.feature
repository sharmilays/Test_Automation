@AddNDCDiflucan
Feature: Add NDCs for Diflucan

  @18325
  Scenario Outline: Verify that agent should be able to see/Select the new NDC’s active for Diflucan
    ...
    Examples: 
      | TC_ID                     |  | TestDataSheet      |
      | AddNDCSforDiflucan_183250 |  | AddNDCSforDiflucan |
  ...
  Scenario Outline: Verify that the product should be defaulted to be shipped via Memphis & to HCP
    ...
    Examples: 
      | TC_ID                     |  | TestDataSheet      |
      | AddNDCSforDiflucan_183252 |  | AddNDCSforDiflucan |

  @183260
  Scenario Outline: Verify user is able to see all the details added under product information
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                     |  | TestDataSheet      |
      | AddNDCSforDiflucan_183260 |  | AddNDCSforDiflucan |
  ...
  Scenario Outline: Verify that on application prescription the refills should be defaulted to 4
    ...
    Examples: 
      | TC_ID                     |  | TestDataSheet      |
      | AddNDCSforDiflucan_183255 |  | AddNDCSforDiflucan |

  @183256
  Scenario Outline: Verify that on Diflucan product will be available only when an LOE appeal is approved
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                     |  | TestDataSheet      |
      | AddNDCSforDiflucan_183256 |  | AddNDCSforDiflucan |

  @183258
  Scenario Outline: Verify user is able to do Refill for Diflucan
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                     |  | TestDataSheet      |
      | AddNDCSforDiflucan_183258 |  | AddNDCSforDiflucan |

  @183251
  Scenario Outline: Verify that new NDCs added will be mapped to LOE group
    Given TestCaseID Is "<TC_ID>" and TestDataSheet Is "<TestDataSheet>"
    And open Browser and enter url
    When Enter username and password
    And Click On Login Button
    ...
    Examples: 
      | TC_ID                     |  | TestDataSheet      |
      | AddNDCSforDiflucan_183251 |  | AddNDCSforDiflucan |
  ...
  Scenario Outline: Verify user should not be able to do Refill if Rx is expired
    ...
    Examples: 
      | TC_ID                     |  | TestDataSheet      |
      | AddNDCSforDiflucan_183261 |  | AddNDCSforDiflucan |
